...
PLUGIN_DIR=$(pwd)
DB_SERVE_NAME=${DB_SERVE_NAME-tests}
...
setup_plugin() {
	...
	if [ ! -d $WP_CORE_DIR/wp-content/plugins/wp-ever-accounting ]; then
		ln -s $PLUGIN_DIR $WP_CORE_DIR/wp-content/plugins/wp-ever-accounting
	...
	# activate the plugin
	wp plugin activate wp-ever-accounting
