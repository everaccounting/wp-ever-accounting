...
class FormattingTest extends \Codeception\TestCase\WPTestCase {
	/**
	 * @var \WpunitTester
	 */
	protected $tester;
	 ...
	 * @since 1.0.1
	 */
	public function test_eaccounting_string_to_array() {
		$this->assertEquals(
			array(
				'foo',
				'bar',
	 ...
	 * @since 1.0.1
	 */
	public function test_eaccounting_clean() {
	 ...
	 * @since 1.0.2
	 */
	public function test_eaccounting_sanitize_textarea() {
	 ...
	 * @since 1.0.2
	 */
	public function test_eaccounting_sanitize_tooltip() {
