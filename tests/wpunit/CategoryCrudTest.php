...
class CategoryCrudTest extends \Codeception\TestCase\WPTestCase {
	/**
	 * @var \WpunitTester
	 */
	protected $tester;
	...
	public function test_delete_category() {
		$category = $this->tester->create_category();
		$this->assertNotFalse( $category->exists() );
	...
	public function test_exception_category() {
		...
		$this->assertEquals( 'Category name already exists.', $category->get_error_message() );
