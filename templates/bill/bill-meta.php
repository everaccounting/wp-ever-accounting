...
<table class="ea-document__meta">
	...
	<tr>
		...
		<td>:</td>
		<td><?php echo empty( $bill->get_issue_date() ) ? '&mdash;' : Formatting::date( $bill->get_issue_date(), 'M j, Y' ); ?></td>
	</tr>
	<tr>
		<th><?php esc_html_e( 'Due Date', 'wp-ever-accounting' ); ?></th>
		<td>:</td>
		<td><?php echo empty( $bill->get_due_date() ) ? '&mdash;' : Formatting::date( $bill->get_due_date(), 'M j, Y' ); ?></td>
	</tr>
	<tr>
		<th><?php esc_html_e( 'Payment Date', 'wp-ever-accounting' ); ?></th>
		<td>:</td>
		<td><?php echo empty( $bill->get_payment_date() ) ? '&mdash;' : Formatting::date( $bill->get_payment_date(), 'M j, Y' ); ?></td>
	</tr>
</table>
