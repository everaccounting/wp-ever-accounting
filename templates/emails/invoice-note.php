...
/*
 * @hooked Mailer::email_header() Output the email header
 */
...
<p><?php esc_html_e( 'The following note has been added to your order:', 'wp-ever-accounting' ); ?></p>
...
<p><?php esc_html_e( 'As a reminder, here are your order details:', 'wp-ever-accounting' ); ?></p>
...
// * @since 2.5.0
// */
//do_action( 'woocommerce_email_order_details', $invoice, $sent_to_admin, $plain_text, $email );
//
///*
...
/*
 * @hooked Mailer::email_footer() Output the email footer
 */
