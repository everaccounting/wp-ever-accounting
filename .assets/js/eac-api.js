(function (document, window, $) {
	...
	// Extend settings.
	eac.api.settings = eac.api.settings || {};
	 ...
	 * @since 1.0.0
	 */
	eac.api.Model = Backbone.Model.extend({
		/**
		 * API root.
		 */
	 ...
	 * @since 1.0.0
	 */
	eac.api.Account = eac.api.Model.extend({
		endpoint: 'accounts',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Contact = eac.api.Model.extend({
		endpoint: 'contacts',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Customer = eac.api.Contact.extend({
		endpoint: 'customers',

		defaults: Object.assign({}, eac.api.Contact.prototype.defaults, {
			type: 'customer',
		}),
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Category = eac.api.Model.extend({
		endpoint: 'categories',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Document =eac.api.Model.extend({
		defaults: {
			id: '',
			type: '',
			status: 'draft',
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentItem = eac.api.Model.extend({
		endpoint: 'line-items',
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentTax = eac.api.Model.extend({
		endpoint: 'line-taxes',
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentAddress = eac.api.Model.extend({
		endpoint: 'addresses',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Invoice = eac.api.Document.extend({
		defaults: Object.assign({}, eac.api.Document.prototype.defaults, {
			type: 'invoice',
		}),
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Bill = eac.api.Document.extend({
		defaults: Object.assign({}, eac.api.Document.prototype.defaults, {
			type: 'bill',
		}),
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Transaction = eac.api.Model.extend({
	 ...
	 * @since 1.0.0
	 */
	eac.api.Payment = eac.api.Transaction.extend({
		defaults: Object.assign({}, eac.api.Transaction.prototype.defaults, {
			type: 'payment',
		}),
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Expense = eac.api.Transaction.extend({
		defaults: Object.assign({}, eac.api.Transaction.prototype.defaults, {
			type: 'expense',
		}),
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Item = eac.api.Model.extend({
		endpoint: 'items',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Tax = eac.api.Model.extend({
		endpoint: 'taxes',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Note = eac.api.Model.extend({
		endpoint: 'notes',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Vendor = eac.api.Contact.extend({
		endpoint: 'vendors',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Collection = Backbone.Collection.extend({
		/**
		 * API root.
		 */
		apiRoot: wpApiSettings.root || '/wp-json',
	 ...
	 * @since 1.0.0
	 */
	eac.api.Accounts = eac.api.Collection.extend({
		endpoint: 'accounts',
		model: eac.api.Account,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Contacts = eac.api.Collection.extend({
		endpoint: 'contacts',
		model: eac.api.Contact,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Customers = eac.api.Collection.extend({
		endpoint: 'customers',
		model: eac.api.Customer,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Categories = eac.api.Collection.extend({
		endpoint: 'categories',
		model: eac.api.Category,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Documents = eac.api.Collection.extend({
		endpoint: 'documents',
		model: eac.api.Document,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentItems = eac.api.Collection.extend({
		endpoint: 'document/items',
		model: eac.api.DocumentItem,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentTaxes = eac.api.Collection.extend({
		endpoint: 'line-taxes',
		model: eac.api.DocumentTax,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.DocumentAddresses = eac.api.Collection.extend({
		endpoint: 'addresses',
		model: eac.api.DocumentAddress,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Invoices = eac.api.Collection.extend({
		endpoint: 'invoices',
		model: eac.api.Invoice,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Bills = eac.api.Collection.extend({
		endpoint: 'bills',
		model: eac.api.Bill,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Transactions = eac.api.Collection.extend({
		endpoint: 'transactions',
		model: eac.api.Transaction,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Payments = eac.api.Collection.extend({
		endpoint: 'payments',
		model: eac.api.Payment,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Expenses = eac.api.Collection.extend({
		endpoint: 'expenses',
		model: eac.api.Expense,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Items = eac.api.Collection.extend({
		endpoint: 'items',
		model: eac.api.Item,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Taxes = eac.api.Collection.extend({
		endpoint: 'taxes',
		model: eac.api.Tax,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Notes = eac.api.Collection.extend({
		endpoint: 'notes',
		model: eac.api.Note,
	});
	 ...
	 * @since 1.0.0
	 */
	eac.api.Vendors = eac.api.Collection.extend({
		endpoint: 'vendors',
		model: eac.api.Vendor,
	});
