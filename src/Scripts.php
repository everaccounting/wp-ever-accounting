...
class Scripts extends Singleton {
	...
	public function enqueue_scripts() {
		if ( empty( get_query_var( 'eac_endpoint' ) ) ) {
			return;
		}
		...
		if ( in_array( $screen_id, eac_get_screen_ids(), true ) ) {
			...
			wp_localize_script(
				...
				array(
					...
					'currency_symbol'    => eac_get_currency_symbol(),
					'currency_precision' => eac_get_currency_precision(),
					'thousand_sep'       => eac_get_currency_thousand_separator(),
					'decimal_sep'        => eac_get_currency_decimal_separator(),
