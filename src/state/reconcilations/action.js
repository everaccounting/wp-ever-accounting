...
export const setUpdateItem = (id, item) => (dispatch, getState) => updateItem(eAccountingApi.reconciliations.update, id, item, STATUS_RECONCILIATIONS_ITEM, dispatch, getState().reconciliations);
export const setGetItems = args => (dispatch, getState) => getItems(eAccountingApi.reconciliations.list, dispatch, STATUS_RECONCILIATION, args, getState().reconciliations);
...
export const setBulkAction = (action, ids ) =>  (dispatch, getState) => bulkAction(eAccountingApi.reconciliations.bulk, action, ids, STATUS_RECONCILIATION, dispatch, getState().reconciliations);
