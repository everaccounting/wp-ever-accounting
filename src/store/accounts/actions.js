...
export const fetchAccounts = (params = {}, reduxer = s => s) => (dispatch, getState) => {
	...
	return dispatch({
		type: "ACCOUNTS",
		payload: apiRequest(accountingApi.accounts.list(data)),
...
export const BulkAction = (action, ids) => (dispatch, getState) => {
	...
	return dispatch({
		type: "ACCOUNTS",
		payload: apiRequest(accountingApi.accounts.bulk(action, params, removeDefaults(table, 'paid_at'))),
