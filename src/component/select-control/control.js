...
class Control extends Component {
	...
	renderInput() {
		...
		return (
			<input
				autoComplete="off"
				className="ea-select-control woocommerce-select-control__control-input"
				...
				<div className="components-base-control__field">
					{ !! label && (
						<label
							...
							className="ea-control-label components-base-control__label"
						>
							{ label }
						</label>
					) }

					{inlineTags && <div className='ea-inline-tags-base-control'><Tags { ...this.props } /> {this.renderInput()}</div>}

					{!inlineTags && this.renderInput() }
					...
					{ !! help && (
						<p
							...
							className="ea-control-help components-base-control__help"
						>
							{ help }
						</p>
					) }
