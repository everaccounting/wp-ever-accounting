...
export const setUpdateItem = (id, item) => (dispatch, getState) => updateItem(accountingApi.taxrates.update, id, item, STATUS_TAXRATES_ITEM, dispatch, getState().taxrates);
export const setGetItems = args => (dispatch, getState) => getItems(accountingApi.taxrates.list, dispatch, STATUS_TAXRATE, args, getState().taxrates);
...
export const setBulkAction = (action, ids ) =>  (dispatch, getState) => bulkAction(accountingApi.taxrates.bulk, action, ids, STATUS_TAXRATE, dispatch, getState().taxrates);
