...
export const setUpdateItem = (id, item) => (dispatch, getState) => updateItem(accountingApi.revenues.update, id, item, STATUS_REVENUES_ITEM, dispatch, getState().revenues);
export const setGetItems = args => (dispatch, getState) => getItems(accountingApi.revenues.list, dispatch, STATUS_REVENUE, args, getState().revenues);
...
export const setBulkAction = (action, ids ) =>  (dispatch, getState) => bulkAction(accountingApi.revenues.bulk, action, ids, STATUS_REVENUE, dispatch, getState().revenues);
