...
export const setUpdateItem = (id, item) => (dispatch, getState) =>
	updateItem(accountingApi.contacts.update, id, item, STATUS_CONTACTS_ITEM, dispatch, getState().contacts);
export const setGetItems = args => (dispatch, getState) =>
	getItems(accountingApi.contacts.list, dispatch, STATUS_CONTACT, args, getState().contacts);
...
export const setBulkAction = (action, ids) => (dispatch, getState) =>
	bulkAction(accountingApi.contacts.bulk, action, ids, STATUS_CONTACT, dispatch, getState().contacts);
