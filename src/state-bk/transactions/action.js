 ...
 */
import { TRANSACTIONS_LOADING, TRANSACTIONS_LOADED, TRANSACTIONS_FAILED } from './type';
...
export const setGetItems = args => (dispatch, getState) =>
	getItems(accountingApi.transactions.list, dispatch, STATUS_TRANSACTION, args, getState().transactions);
