 ...
 *
 * @since 1.0.2
 * @package EverExpenseing\Admin\ListTables
 */
class Expenses extends ListTable {
	...
	public function prepare_items() {
		...
		$this->total_count = eac_get_expenses( $args, true );
	 ...
	 *
	 * @param Expense $item The current account object.
	 *
	 * @since  1.0.2
	 * @return string Displays a checkbox.
	 */
	public function column_cb( $item ) {
		return sprintf( '<input type="checkbox" name="expense_ids[]" value="%d"/>', esc_attr( $item->get_id() ) );
	}
