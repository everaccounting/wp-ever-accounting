...
abstract class Tab {
	...
	public function __construct() {
		...
		add_action( 'ever_accounting_sections_' . $this->id, array( $this, 'output_sections' ) );
		add_action( 'ever_accounting_settings_' . $this->id, array( $this, 'output' ) );
	...
	public function output_sections() {
		...
		foreach ( $sections as $id => $label ) {
			$url       = admin_url( 'admin.php?page=ea-settings&tab=' . $this->id . '&section=' . sanitize_title( $id ) );
