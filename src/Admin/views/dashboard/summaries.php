	...
	<ul class="eac-summaries">
		<li class="eac-summary">
			...
			<div class="eac-summary__data">
				<div class="eac-summary__value"><?php echo esc_html( eac_format_money( $sales_summary['total'] ) ); ?></div>
			</div>
		...
		<li class="eac-summary">
			...
			<div class="eac-summary__data">
				<div class="eac-summary__value"><?php echo esc_html( eac_format_money( $purchases_summary['total'] ) ); ?></div>
			</div>
			<div class="eac-summary__legend"><?php esc_html_e( 'This Month', 'wp-ever-accounting' ); ?></div>
		</li>
		<li class="eac-summary">
			...
			<div class="eac-summary__data">
				<div class="eac-summary__value"><?php echo esc_html( eac_format_money( $profits_summary['total'] ) ); ?></div>
			</div>
			<div class="eac-summary__legend"><?php esc_html_e( 'This Month', 'wp-ever-accounting' ); ?></div>
		</li>
	</ul>
