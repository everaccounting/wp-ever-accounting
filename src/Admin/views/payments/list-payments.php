 ...
 * @subpackage  Admin/View/Payments
 */
...
?>
	<div class="eac-page__header">
		<div class="eac-page__header-col">
			<h2 class="eac-page__title"><?php esc_html_e( 'Payments', 'ever-accounting' ); ?></h2>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=eac-sales&tab=payments&action=add' ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add New', 'ever-accounting' ); ?></a>
...
<?php do_action( 'ever_accounting_payments_table_top' ); ?>
	<form method="get" id="eac-payments-table">
		<?php
		$list_table->views();
...
<?php
do_action( 'ever_accounting_payments_table_bottom' );
