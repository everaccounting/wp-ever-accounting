...
?>
	...
	<div class="eac-section-header">
		<div>
			...
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=eac-settings&tab=categories&action=add' ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add New', 'wp-ever-accounting' ); ?></a>
		</div>
	</div>
