...
<div class="eac-page__header">
	...
	<div class="eac-page__header-col">
		<?php if ( $transfer->exists() ) : ?>
			...
			<!--view-->
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=eac-banking&tab=transfers&action=view&transfer_id=' . $transfer->get_id() ) ); ?>" class="button button-secondary">
				<?php esc_html_e( 'View Transfer', 'wp-ever-accounting' ); ?>
			</a>
		<?php endif; ?>
