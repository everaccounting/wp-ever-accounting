...
?>
	<div class="eac-section-header">
		<div>
			<h2><?php esc_html_e( 'Transfers', 'wp-ever-accounting' ); ?></h2>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=eac-banking&tab=transfers&action=add' ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add New', 'wp-ever-accounting' ); ?></a>
