...
?>
	...
	<div class="eac-section-header">
		<div>
			...
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=eac-purchases&tab=vendors' ) ); ?>"><span class="dashicons dashicons-undo"></span></a>
		</div>
		<div>
			<?php if ( $vendor->exists() ) : ?>
				<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=eac-purchases&tab=vendors&action=delete&vendor_id=' . $vendor->get_id() ), 'bulk-vendor' ) ); ?>" class="del">
