 ...
 * @subpackage EverAccounting/admin/views/bills
 * @var Bill $document Document object.
 */
...
$vendors     = eac_get_vendors( array( 'include' => $document->get_contact_id() ) );
...
?>
<form id="eac-bill-form" class="eac-document-form eac-ajax-form" method="post" autocomplete="off">
	<div class="eac-panel">
			...
			<div class="eac-col-6">
				...
				eac_form_field(
					array(
						...
						'id'          => 'vendor_id',
						'name'        => 'contact_id',
						'label'       => __( 'Vendor', 'ever-accounting' ),
						'options'     => wp_list_pluck( $vendors, 'formatted_name', 'id' ),
						'value'       => $document->get_contact_id(),
						'placeholder' => __( 'Select a vendor', 'ever-accounting' ),
				...
				<h3>
					<?php esc_html_e( 'Vendor details', 'ever-accounting' ); ?>
