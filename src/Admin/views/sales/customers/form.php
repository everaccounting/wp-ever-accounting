...
//	"
//	jQuery('#ea-customer-form #amount').inputmask('decimal', {
//			alias: 'numeric',
//			groupSeparator: '" . $customer->get_currency_thousand_separator() . "',
//			autoGroup: true,
//			digits: '" . $customer->get_currency_precision() . "',
//			radixPoint: '" . $customer->get_currency_decimal_separator() . "',
//			digitsOptional: false,
//			allowMinus: false,
//			prefix: '" . $customer->get_currency_symbol() . "',
//			placeholder: '0.000',
//			rightAlign: 0,
//			autoUnmask: true
//		});
