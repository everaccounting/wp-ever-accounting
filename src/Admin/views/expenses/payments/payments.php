...
?>
	<h1 class="wp-heading-inline">
		...
		<a href="<?php echo esc_attr( admin_url( 'admin.php?page=eac-expenses&tab=payments&add=yes' ) ); ?>" class="page-title-action">
	...
	<form method="get" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>">
		...
		<input type="hidden" name="page" value="eac-payments"/>
	</form>
<?php
