			...
			<div class="column-2">
				<div class="bkit-card">
					...
					<div class="bkit-card__footer">
						...
						<?php // else : ?>
						<button class="button button-primary bkit-w-100"><?php esc_html_e( 'Add Bill', 'wp-ever-accounting' ); ?></button>
						<?php // endif; ?>
					</div>
				</div>
			</div><!-- .column-2 -->
...
//	"
//	jQuery('#ea-bill-form #amount').inputmask('decimal', {
//			alias: 'numeric',
//			groupSeparator: '" . $bill->get_currency_thousand_separator() . "',
//			autoGroup: true,
//			digits: '" . $bill->get_currency_precision() . "',
//			radixPoint: '" . $bill->get_currency_decimal_separator() . "',
//			digitsOptional: false,
//			allowMinus: false,
//			prefix: '" . $bill->get_currency_symbol() . "',
//			placeholder: '0.000',
//			rightAlign: 0,
//			autoUnmask: true
//		});
