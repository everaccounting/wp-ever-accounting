 ...
 */
class DocumentTax_BK extends Model {
	/**
	 * Table name.
	 *
	...
	*/
	...
	public function set_discount( $value ) {
		$this->set_prop( 'discount', eac_sanitize_number( $value, 4 ) );
	}
	...
	public function set_shipping( $value ) {
		$this->set_prop( 'shipping', eac_sanitize_number( $value, 4 ) );
	}
	 ...
	 * Set fee.
	 *
	 * @param float $value Fee tax.
	 *
	 * @since  1.1.0
	 */
	public function set_fee( $value ) {
		$this->set_prop( 'fee', eac_sanitize_number( $value, 4 ) );
	}
	...
	*/
	...
	public function merge( $line_tax ) {
		...
		$this->set_subtotal( $this->get_subtotal() + $line_tax->get_subtotal() );
		$this->set_shipping( $this->get_shipping() + $line_tax->get_shipping() );
		$this->set_fee( $this->get_fee() + $line_tax->get_fee() );
		$this->set_discount( $this->get_discount() + $line_tax->get_discount() );
		$this->set_total( $this->get_total() + $line_tax->get_total() );
	}
