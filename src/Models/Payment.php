...
class Payment extends Transaction {
	...
	public function __construct( $data = 0 ) {
		...
		$this->core_data['account_id']     = get_option( 'eac_payment_account_id', 0 );
		$this->core_data['category_id']    = get_option( 'eac_payment_category_id', 0 );
		$this->core_data['payment_method'] = get_option( 'eac_payment_payment_method', 'cash' );
