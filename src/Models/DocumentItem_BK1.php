 ...
 */
class DocumentItem_BK1 extends Model {
	/**
	 * Table name.
	 *
	...
	*/
	...
	public function set_price( $value ) {
		$this->set_prop( 'price', eac_round_number( $value ) );
	}
	...
	public function set_quantity( $value ) {
		$this->set_prop( 'quantity', eac_round_number( $value ) );
	}
	...
	public function set_subtotal( $subtotal ) {
		$this->set_prop( 'subtotal', eac_round_number( $subtotal ) );
	}
	...
	public function set_subtotal_tax( $value ) {
		$this->set_prop( 'subtotal_tax', eac_round_number( $value ) );
	}
	...
	public function set_discount( $discount ) {
		$this->set_prop( 'discount', eac_round_number( $discount ) );
	}
	...
	public function set_discount_tax( $value ) {
		$this->set_prop( 'discount_tax', eac_round_number( $value ) );
	}
	...
	public function set_shipping( $shipping ) {
		$this->set_prop( 'shipping', eac_round_number( $shipping ) );
	}
	...
	public function set_shipping_tax( $shipping_tax ) {
		$this->set_prop( 'shipping_tax', eac_round_number( $shipping_tax ) );
	}
	...
	public function set_fee( $fee ) {
		$this->set_prop( 'fee', eac_round_number( $fee ) );
	}
	...
	public function set_fee_tax( $fee_tax ) {
		$this->set_prop( 'fee_tax', eac_round_number( $fee_tax ) );
	}
	...
	public function set_tax_total( $value ) {
		$this->set_prop( 'tax_total', eac_round_number( $value ) );
	}
	...
	public function set_total( $total ) {
		$this->set_prop( 'total', eac_round_number( $total ) );
	}
