/*! Select2 4.0.3 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function(a) {
	...
	var b = (function() {
			...
			return (
					...
					return (
						(b.prototype.current = function(b, c) {
							function d(b, c) {
								var e = [];
								return (
									b.selected || -1 !== a.inArray(b.id, c) ? ((b.selected = !0), e.push(b)) : (b.selected = !1),
				...
				(function(c) {
					...
					var k = (a.event.special.mousewheel = {
						...
						getLineHeight: function(b) {
							...
							return (
								d.length || (d = a('body')), parseInt(d.css('fontSize'), 10) || parseInt(c.css('fontSize'), 10) || 16
							);
						},
				...
				b.define('jquery.select2', ['jquery', 'jquery-mousewheel', './select2/core', './select2/defaults'], function(
					a,
					b,
					c,
					d
