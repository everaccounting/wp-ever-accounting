	...
	function e(e) {
		function t(t, n) {
			...
			if (!(n = e.extend({}, e.blockUI.defaults, n || {})).ignoreIfBlocked || !e(t).data('blockUI.isBlocked')) {
				...
				if (u || O) {
					if (
						(k && n.allowBodyStretch && e.support.boxModel && e('html,body').css('height', '100%'),
				...
				if (
					(y &&
						(n.theme ? w.find('.ui-widget-content').append(y) : w.append(y), (y.jquery || y.nodeType) && e(y).show()),
				...
				if (
					(i(1, t, n),
					k
						? ((p = w[0]), (b = e(n.focusableElements, p)), n.focusInput && setTimeout(l, 20))
		...
		function o(t, o) {
			...
			c && (clearTimeout(c), d.removeData('blockUI.timeout')),
				...
				i(0, t, o),
				null === o.onUnblock && ((o.onUnblock = d.data('blockUI.onUnblock')), d.removeData('blockUI.onUnblock'));
			var r;
			(r = l
				? e(document.body)
						.children()
				...
				: d.find('>.blockUI')),
				o.cursorReset &&
					(r.length > 1 && (r[1].style.cursor = o.cursorReset), r.length > 2 && (r[2].style.cursor = o.cursorReset)),
				l && (p = b = null),
				o.fadeOut
					? ((s = r.length),
