...
!(function(a) {
	...
	a.extend(a.fn, {
		...
		rules: function(b, c) {
			...
			if (
				null != j &&
				(!j.form && k && ((j.form = this.closest('form')[0]), (j.name = this.attr('name'))), null != j.form)
			) {
				if (b)
		...
		a.extend(a.validator, {
			...
			prototype: {
				init: function() {
					function b(b) {
						var c =
							'undefined' != typeof a(this).attr('contenteditable') && 'false' !== a(this).attr('contenteditable');
						if (
							(!this.form && c && ((this.form = a(this).closest('form')[0]), (this.name = a(this).attr('name'))),
							d === this.form)
						) {
				...
				check: function(b) {
					...
					for (d in g) {
						...
						try {
							if (
								((c = a.validator.methods[d].call(this, j, b, e.parameters)), 'dependency-mismatch' === c && 1 === h)
							) {
								i = !0;
								continue;
							}
