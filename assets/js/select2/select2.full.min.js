...
!(function (n) {
	'function' == typeof define && define.amd
		...
		? (module.exports = function (e, t) {
				return (
					t === undefined && (t = 'undefined' != typeof window ? require('jquery') : require('jquery')(e)), n(t), t
				);
		  })
		: n(jQuery);
})(function (t) {
	var e,
		...
		c,
		u =
			(t && t.fn && t.fn.select2 && t.fn.select2.amd && (e = t.fn.select2.amd),
			(e && e.requirejs) ||
				(e ? (i = e) : (e = {}),
				(m = {}),
				(v = {}),
				...
				(o = function (e, t, n, i) {
					...
					if ('undefined' == d || 'function' == d) {
						for (t = !t.length && n.length ? ['require', 'exports', 'module'] : t, l = 0; l < t.length; l += 1)
							if ('require' === (o = (a = f(t[l], p)).f)) u[l] = g.require(e);
							else if ('exports' === o) (u[l] = g.exports(e)), (c = !0);
							else if ('module' === o) r = u[l] = g.module(e);
							else if (b(m, o) || b(v, o) || b(_, o)) u[l] = x(o);
							else {
						...
						(s = n ? n.apply(m[e], u) : undefined),
							e && (r && r.exports !== h && r.exports !== m[e] ? (m[e] = r.exports) : (s === h && c) || (m[e] = s));
					} else e && (m[e] = n);
				}),
				(n = i = s = function (e, t, n, i, r) {
					if ('string' == typeof e) return g[e] ? g[e](t) : x(f(e, D(t)).f);
					if (!e.splice) {
				...
				(r.Extend = function (e, t) {
					...
					(r.Decorate = function (i, r) {
						...
						function o() {
							...
							0 < t && (e.call(arguments, i.prototype.constructor), (n = r.prototype.constructor)),
						...
						this.$results.attr('id', n),
							...
							t.on('results:previous', function () {
								...
								a <= 0 ||
									((e = a - 1),
									0 === o.length && (e = 0),
									(t = s.eq(e)).trigger('mouseenter'),
									(n = l.$results.offset().top),
									(i = t.offset().top),
									(r = l.$results.scrollTop() + (i - n)),
									0 === e ? l.$results.scrollTop(0) : i - n < 0 && l.$results.scrollTop(r));
							}),
							t.on('results:next', function () {
								var e,
									...
									n,
									i,
									r = l.getHighlightedResults(),
									o = l.$results.find('[aria-selected]'),
									s = o.index(r) + 1;
								s >= o.length ||
									((e = o.eq(s)).trigger('mouseenter'),
									(t = l.$results.offset().top + l.$results.outerHeight(!1)),
									(n = e.offset().top + e.outerHeight(!1)),
									(i = l.$results.scrollTop() + n - t),
									0 === s ? l.$results.scrollTop(0) : t < n && l.$results.scrollTop(i));
							}),
					...
					(i.prototype.ensureHighlightVisible = function () {
						...
						0 !== o.length &&
							...
							e <= 2
								...
								: (r > this.$results.outerHeight() || r < 0) && this.$results.scrollTop(i));
					}),
					...
					(r.prototype.update = function (e) {
						...
						0 !== e.length
							? ((t = e[0]),
							  ...
							  (i = this.display(t, n)),
							  n.empty().append(i),
							  (r = t.title || t.text) ? n.attr('title', r) : n.removeAttr('title'))
							: this.clear();
					}),
					r
				);
			...
			e.define('select2/selection/multiple', ['jquery', './base', '../utils'], function (r, e, l) {
				...
				return (
					...
					(n.prototype.render = function () {
						...
						return (
							e.addClass('select2-selection--multiple'), e.html('<ul class="select2-selection__rendered"></ul>'), e
						);
					}),
						...
						e.call(this, t, n),
							...
							this.$selection.on('keydown', '.select2-search--inline', function (e) {
								...
								e.stopPropagation(),
									...
									e.which !== l.BACKSPACE ||
										'' !== i.$search.val() ||
										(0 < (t = i.$searchContainer.prev('.select2-selection__choice')).length &&
											((n = a.GetData(t[0], 'data')), i.searchRemoveChoice(n), e.preventDefault()));
							}),
						...
						this.$selection.on('input.searchcheck', '.select2-search--inline', function (e) {
							...
							this.$selection.on('keyup.search input.search', '.select2-search--inline', function (e) {
								...
								s && 'input' === e.type
									...
									: (t = e.which) != l.SHIFT && t != l.CTRL && t != l.ALT && t != l.TAB && i.handleSearch(e);
							});
					}),
					...
					(n.prototype.query = function (i, e) {
						...
						this.$element.children().each(function () {
							var e,
								t,
								n = l(this);
							(n.is('option') || n.is('optgroup')) && ((e = o.item(n)), null !== (t = o.matches(i, e)) && r.push(t));
						}),
							e({ results: r });
					}),
						...
						for (
							...
							0 <= f.inArray(p.id, i)
								? ((s = n.filter(
								  ...
								  s.replaceWith(c))
								: ((u = this.option(p)),
								  p.children && ((d = this.convertToOptions(p.children)), h.appendMany(u, d)),
								  r.push(u));
						}
						return r;
					}),
			...
			e.define('select2/data/tags', ['jquery'], function (u) {
				function e(e, t, n) {
					...
					if ((o !== undefined && (this.insertTag = o), e.call(this, t, n), u.isArray(i)))
						for (var s = 0; s < i.length; s++) {
							var a = i[s],
							...
							null != l.term && null == l.page
								? e.call(this, l, function d(e, t) {
										for (var n = e.results, i = 0; i < n.length; i++) {
											var r = n[i],
												o = null != r.children && !d({ results: r.children }, !0);
											if ((r.text || '').toUpperCase() === (l.term || '').toUpperCase() || o)
												return !t && ((e.data = n), void c(e));
										}
										if (t) return !0;
										var s,
											a = u.createTag(l);
										null != a && ((s = u.option(a)).attr('data-select2-tag', !0), u.addOptions([s]), u.insertTag(n, a)),
											(e.results = n),
											c(e);
								  })
								: e.call(this, l, c);
				...
				return (
					...
					(e.prototype.query = function (e, t, n) {
						...
						var i = this.tokenizer(t, this.options, function (e) {
							...
							}).length || ((t = r.option(i)).attr('data-select2-tag', !0), r._removeOldTags(), r.addOptions([t])),
								(n = i),
					...
					(e.prototype.tokenizer = function (e, t, n, i) {
						for (
							...
							-1 !== d.inArray(u, r)
								? ((l = o.substr(0, s)),
								  null != (c = a(d.extend({}, t, { term: l }))) ? (i(c), (o = o.substr(s + 1) || ''), (s = 0)) : s++)
								: s++;
						}
						return { term: o };
					}),
			...
			e.define('select2/dropdown/selectOnClose', ['../utils'], function (o) {
				...
				return (
					...
					(e.prototype._handleSelectOnClose = function (e, t) {
						...
						r.length < 1 ||
							(null != (i = o.GetData(r[0], 'data')).element && i.element.selected) ||
			...
			e.define(
				...
				function (c, u, d, p, h, f, g, m, v, y, l, t, _, w, $, b, A, x, D, S, C, E, O, T, q, j, L, I, e) {
					function n() {
						this.reset();
					}
					return (
						(n.prototype.apply = function (e) {
							...
							null == (e = c.extend(!0, {}, this.defaults, e)).dataAdapter &&
								...
								null != e.initSelection &&
									((n = u(e.amdBase + 'compat/initSelection')), (e.dataAdapter = y.Decorate(e.dataAdapter, n)))),
								...
								null == e.dropdownAdapter &&
									(e.multiple ? (e.dropdownAdapter = C) : ((i = y.Decorate(C, E)), (e.dropdownAdapter = i)),
									...
									(null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass) ||
										((r = u(e.amdBase + 'compat/dropdownCss')), (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, r))),
								...
								null == e.selectionAdapter &&
									...
									(null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass) ||
										((o = u(e.amdBase + 'compat/containerCss')),
							...
							this.defaults = {
								...
								matcher: function a(e, t) {
									...
									if (t.children && 0 < t.children.length) {
										for (var n = c.extend(!0, {}, t), i = t.children.length - 1; 0 <= i; i--)
						...
						(n.prototype._resolveLanguage = function (e) {
							...
							for (var t, n = c.isArray(e) ? e : [e], i = [], r = 0; r < n.length; r++)
								i.push(n[r]), 'string' == typeof n[r] && 0 < n[r].indexOf('-') && ((t = n[r].split('-')[0]), i.push(t));
							return i;
						}),
						(n.prototype._processTranslations = function (e, t) {
							for (var n = new l(), i = 0; i < e.length; i++) {
								var r = new l(),
									o = e[i];
								if ('string' == typeof o)
									try {
										...
										try {
											(o = this.defaults.amdLanguageBase + o), (r = l.loadPath(o));
										} catch (a) {
											t &&
												window.console &&
												console.warn &&
								...
								else r = c.isPlainObject(o) ? new l(o) : o;
								n.extend(r);
							}
							return n;
						}),
			...
			e.define('select2/options', ['require', 'jquery', './defaults', './utils'], function (i, d, r, p) {
				function e(e, t) {
					...
					(this.options = e),
						...
						t &&
							t.is('input') &&
							((n = i(this.get('amdBase') + 'compat/inputData')),
				...
				return (
					(e.prototype.fromElement = function (e) {
						...
						for (var r = 0; r < e[0].attributes.length; r++) {
							var o,
								s,
								a = e[0].attributes[r].name,
								l = 'data-';
							a.substr(0, l.length) == l &&
								((o = a.substring(l.length)), (s = p.GetData(e[0], o)), (n[o.replace(/-([a-z])/g, i)] = s));
						}
						...
						for (var u in c)
							-1 < d.inArray(u, t) ||
								(d.isPlainObject(this.options[u]) ? d.extend(this.options[u], c[u]) : (this.options[u] = c[u]));
						return this;
					}),
			...
			e.define('select2/compat/utils', ['jquery'], function (s) {
				return {
					syncCssClasses: function (e, t, n) {
						var i,
							r = [],
							o = s.trim(e.attr('class'));
						o &&
							s((o = '' + o).split(/\s+/)).each(function () {
								0 === this.indexOf('select2-') && r.push(this);
							}),
							(o = s.trim(t.attr('class'))) &&
								s((o = '' + o).split(/\s+/)).each(function () {
									0 !== this.indexOf('select2-') && null != (i = n(this)) && r.push(i);
								}),
							e.attr('class', r.join(' '));
					},
				};
			...
			e.define('select2/compat/containerCss', ['jquery', './utils'], function (s, a) {
				...
				return (
					(e.prototype.render = function (e) {
						...
						var i,
							r = this.options.get('adaptContainerCssClass');
						(r = r || l),
							-1 !== n.indexOf(':all:') &&
								((n = n.replace(':all:', '')),
								(i = r),
						...
						return (
							...
							a.syncCssClasses(t, this.$element, r),
							t.css(o),
							t.addClass(n),
							t
						);
			...
			e.define('select2/compat/dropdownCss', ['jquery', './utils'], function (s, a) {
				...
				return (
					(e.prototype.render = function (e) {
						...
						s.isFunction(n) && (n = n(this.$element));
						var i,
							r = this.options.get('adaptDropdownCssClass');
						(r = r || l),
							-1 !== n.indexOf(':all:') &&
								((n = n.replace(':all:', '')),
								(i = r),
							...
							n.push.apply(
								...
								(function o(e, t) {
									...
									return (
										...
										e.children && n.push.apply(n, o(e.children, t)),
										n
									);
								})(r, this.$element.val().split(this._valueSeparator))
							);
						}
						t(n);
					}),
			...
			(c = function (p) {
				...
				var m = (p.event.special.mousewheel = {
					...
					getLineHeight: function (e) {
						...
						return (
							n.length || (n = p('body')), parseInt(n.css('fontSize'), 10) || parseInt(t.css('fontSize'), 10) || 16
						);
					},
				...
				function i(e) {
					var t,
						...
						d = 0;
					if (
						(((e = p.event.fix(o)).type = 'mousewheel'),
						'detail' in o && (c = -1 * o.detail),
						'wheelDelta' in o && (c = o.wheelDelta),
						'wheelDeltaY' in o && (c = o.wheelDeltaY),
						'wheelDeltaX' in o && (l = -1 * o.wheelDeltaX),
						'axis' in o && o.axis === o.HORIZONTAL_AXIS && ((l = -1 * c), (c = 0)),
						(a = 0 === c ? l : c),
						'deltaY' in o && (a = c = -1 * o.deltaY),
						'deltaX' in o && ((l = o.deltaX), 0 === c && (a = -1 * l)),
						0 !== c || 0 !== l)
					)
						return (
							1 === o.deltaMode
								? ((a *= n = p.data(this, 'mousewheel-line-height')), (c *= n), (l *= n))
								: 2 === o.deltaMode && ((a *= i = p.data(this, 'mousewheel-page-height')), (c *= i), (l *= i)),
							(t = Math.max(Math.abs(c), Math.abs(l))),
							(!f || t < f) && y(o, (f = t)) && (f /= 40),
							y(o, t) && ((a /= 40), (l /= 40), (c /= 40)),
							(a = Math[1 <= a ? 'floor' : 'ceil'](a / f)),
							(l = Math[1 <= l ? 'floor' : 'ceil'](l / f)),
							(c = Math[1 <= c ? 'floor' : 'ceil'](c / f)),
							m.settings.normalizeOffset &&
								this.getBoundingClientRect &&
								((r = this.getBoundingClientRect()), (u = e.clientX - r.left), (d = e.clientY - r.top)),
							(e.deltaX = l),
							(e.deltaY = c),
							(e.deltaFactor = f),
							(e.offsetX = u),
							...
							h && clearTimeout(h),
							(h = setTimeout(v, 200)),
							(p.event.dispatch || p.event.handle).apply(this, s)
						);
				}
				function v() {
					f = null;
	...
	function x(e) {
		var t;
		if ((b(v, e) && ((t = v[e]), delete v[e], (_[e] = !0), o.apply(h, t)), !b(m, e) && !b(_, e)))
	...
	var S = u.require('jquery.select2');
	return (t.fn.select2.amd = u), S;
});
