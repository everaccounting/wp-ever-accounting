		...
		u =
			...
			( e && e.requirejs ) ||
				...
				( n = i = s = function ( e, t, n, i, r ) {
					...
					if ( ! e.splice ) {
						if (
							( ( y = e ).deps && s( y.deps, y.callback ), ! t )
						)
							return;
						t.splice
							? ( ( e = t ), ( t = n ), ( n = null ) )
						...
						this.$results.attr( 'id', n ),
							...
							t.on( 'results:next', function () {
								...
								s >= o.length ||
									...
									( n =
										e.offset().top + e.outerHeight( ! 1 ) ),
									( i = l.$results.scrollTop() + n - t ),
									0 === s
										? l.$results.scrollTop( 0 )
										: t < n && l.$results.scrollTop( i ) );
							} ),
			...
			e.define( 'select2/translation', [ 'jquery', 'require' ], function (
				t,
				n
			) {
				function i( e ) {
			...
			e.define(
				...
				function ( e, a, l ) {
					...
					return (
						...
						( n.prototype.bind = function ( e, t ) {
							var n = this;
							( this.container = e ).on( 'select', function (
								e
							) {
								n.select( e.data );
							} ),
						...
						( n.prototype.query = function ( i, e ) {
							...
							this.$element.children().each( function () {
								var e,
									t,
									n = l( this );
								( n.is( 'option' ) || n.is( 'optgroup' ) ) &&
									( ( e = o.item( n ) ),
									null !== ( t = o.matches( i, e ) ) &&
										r.push( t ) );
							} ),
								e( { results: r } );
						} ),
			...
			e.define( 'select2/data/tokenizer', [ 'jquery' ], function ( d ) {
				...
				return (
					...
					( e.prototype.query = function ( e, t, n ) {
						var r = this;
						t.term = t.term || '';
						var i = this.tokenizer( t, this.options, function (
							e
						) {
							var t,
								n,
			...
			e.define( 'select2/compat/initSelection', [ 'jquery' ], function (
				i
			) {
				function e( e, t, n ) {
					n.get( 'debug' ) &&
