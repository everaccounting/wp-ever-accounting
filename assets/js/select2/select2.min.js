...
!(function (n) {
		...
		c =
				...
				(o = function (e, t, n, r) {
					...
					if ('undefined' == d || 'function' == d) {
						for (t = !t.length && n.length ? ['require', 'exports', 'module'] : t, l = 0; l < t.length; l += 1)
							...
							else if ('module' === o) i = u[l] = g.module(e);
							else if (w(m, o) || w(v, o) || w(_, o)) u[l] = x(o);
							else {
				...
				(e.prototype.on = function (e, t) {
					...
					(i.hasScroll = function (e, t) {
						...
						return (
							...
							('scroll' === r || 'scroll' === i || n.innerHeight() < t.scrollHeight || n.innerWidth() < t.scrollWidth)
						);
					}),
				...
				return (
						...
						this.data.current(function (e) {
							...
							t.$results.find('.select2-results__option[aria-selected]').each(function () {
								var e = h(this),
									...
									n = '' + t.id;
								(null != t.element && t.element.selected) || (null == t.element && -1 < h.inArray(n, r))
						...
						this.$results.attr('id', n),
							...
							t.on('results:previous', function () {
								...
								a <= 0 ||
									...
									(r = t.offset().top),
									(i = l.$results.scrollTop() + (r - n)),
									0 === e ? l.$results.scrollTop(0) : r - n < 0 && l.$results.scrollTop(i));
							}),
							t.on('results:next', function () {
								...
								s >= o.length ||
									...
									(r = l.$results.scrollTop() + n - t),
									0 === s ? l.$results.scrollTop(0) : t < n && l.$results.scrollTop(r));
							}),
					...
					(r.prototype.ensureHighlightVisible = function () {
						...
						0 !== o.length &&
							...
							(n = o.offset().top),
							(r = this.$results.scrollTop() + (n - t)),
							(i = n - t),
							(r -= 2 * o.outerHeight(!1)),
							e <= 2
								? this.$results.scrollTop(0)
								: (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(r));
					}),
					...
					(i.prototype.update = function (e) {
						...
						0 !== e.length
							? ((t = e[0]),
							  ...
							  (r = this.display(t, n)),
							  n.empty().append(r),
							  (i = t.title || t.text) ? n.attr('title', i) : n.removeAttr('title'))
							: this.clear();
					}),
					i
				);
			...
			e.define('select2/data/tags', ['jquery'], function (u) {
				function e(e, t, n) {
					var r = n.get('tags'),
						i = n.get('createTag');
					i !== undefined && (this.createTag = i);
					var o = n.get('insertTag');
					if ((o !== undefined && (this.insertTag = o), e.call(this, t, n), u.isArray(r)))
						for (var s = 0; s < r.length; s++) {
							var a = r[s],
							...
							null != l.term && null == l.page
								? e.call(this, l, function d(e, t) {
										for (var n = e.results, r = 0; r < n.length; r++) {
											var i = n[r],
												o = null != i.children && !d({ results: i.children }, !0);
											if ((i.text || '').toUpperCase() === (l.term || '').toUpperCase() || o)
				...
				return (
					...
					(e.prototype.query = function (e, t, n) {
						...
						var r = this.tokenizer(t, this.options, function (e) {
							var t,
								n,
								r = i._normalizeItem(e);
							i.$element.find('option').filter(function () {
								return d(this).val() === r.id;
							}).length || ((t = i.option(r)).attr('data-select2-tag', !0), i._removeOldTags(), i.addOptions([t])),
								(n = r),
								i.trigger('select', { data: n });
						});
						r.term !== t.term &&
							(this.$search.length && (this.$search.val(r.term), this.$search.trigger('focus')), (t.term = r.term)),
							e.call(this, t, n);
					}),
					(e.prototype.tokenizer = function (e, t, n, r) {
						for (
							...
							-1 !== d.inArray(u, i)
								? ((l = o.substr(0, s)),
								  null != (c = a(d.extend({}, t, { term: l }))) ? (r(c), (o = o.substr(s + 1) || ''), (s = 0)) : s++)
								: s++;
						}
						return { term: o };
					}),
			...
			e.define('select2/dropdown/selectOnClose', ['../utils'], function (o) {
				...
				return (
					...
					(e.prototype._handleSelectOnClose = function (e, t) {
						...
						i.length < 1 ||
							(null != (r = o.GetData(i[0], 'data')).element && r.element.selected) ||
			...
			e.define(
				...
				function (c, u, d, p, h, f, g, m, v, y, l, t, _, $, b, w, A, x, D, S, E, C, O, T, q, L, I, j, e) {
					function n() {
						this.reset();
					}
					return (
						(n.prototype.apply = function (e) {
							...
							null == (e = c.extend(!0, {}, this.defaults, e)).dataAdapter &&
								...
								null == e.dropdownAdapter &&
									(e.multiple ? (e.dropdownAdapter = E) : ((r = y.Decorate(E, C)), (e.dropdownAdapter = r)),
									...
									(null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass) ||
										((i = u(e.amdBase + 'compat/dropdownCss')), (e.dropdownAdapter = y.Decorate(e.dropdownAdapter, i))),
							...
							this.defaults = {
								...
								matcher: function a(e, t) {
									...
									if (t.children && 0 < t.children.length) {
										for (var n = c.extend(!0, {}, t), r = t.children.length - 1; 0 <= r; r--)
											null == a(e, t.children[r]) && n.children.splice(r, 1);
										return 0 < n.children.length ? n : a(e, n);
									}
									var i = s(t.text).toUpperCase(),
										o = s(e.term).toUpperCase();
									return -1 < i.indexOf(o) ? t : null;
								},
						...
						(n.prototype._resolveLanguage = function (e) {
							...
							for (var t, n = c.isArray(e) ? e : [e], r = [], i = 0; i < n.length; i++)
								r.push(n[i]), 'string' == typeof n[i] && 0 < n[i].indexOf('-') && ((t = n[i].split('-')[0]), r.push(t));
							return r;
						}),
						(n.prototype._processTranslations = function (e, t) {
							for (var n = new l(), r = 0; r < e.length; r++) {
								var i = new l(),
									o = e[r];
								if ('string' == typeof o)
									try {
										...
										try {
											(o = this.defaults.amdLanguageBase + o), (i = l.loadPath(o));
										} catch (a) {
											t &&
												window.console &&
												console.warn &&
								...
								else i = c.isPlainObject(o) ? new l(o) : o;
								n.extend(i);
							}
							return n;
						}),
			...
			e.define('select2/options', ['require', 'jquery', './defaults', './utils'], function (r, d, i, p) {
				function e(e, t) {
					...
					(this.options = e),
						...
						t &&
							t.is('input') &&
							((n = r(this.get('amdBase') + 'compat/inputData')),
					...
					(e.prototype.fromElement = function (e) {
						...
						for (var i = 0; i < e[0].attributes.length; i++) {
							...
							a.substr(0, l.length) == l &&
								((o = a.substring(l.length)), (s = p.GetData(e[0], o)), (n[o.replace(/-([a-z])/g, r)] = s));
						}
	...
	var p = c.require('jquery.select2');
	return (t.fn.select2.amd = c), p;
});
