! ( function ( o, e, n ) {
	...
	( o.fn.ea_backbone_modal = function ( e ) {
		...
		( o.ea_backbone_modal.defaultOptions = {
			template: '',
			variable: {},
			onSubmit: undefined,
			onReady: undefined,
		...
		( o.ea_backbone_modal.View = e.View.extend( {
			...
			getFormData: function () {
				var n = {};
				return (
					o.each( o( 'form', this.$el ).serializeArray(), function (
						e,
						t
					) {
						-1 !== t.name.indexOf( '[]' )
							? ( ( t.name = t.name.replace( '[]', '' ) ),
							  ( n[ t.name ] = o.makeArray( n[ t.name ] ) ),
							  n[ t.name ].push( t.value ) )
							: ( n[ t.name ] = t.value );
					} ),
					n
				);
