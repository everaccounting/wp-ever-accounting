jQuery(
	function ($) {
		...
		$.eaccounting_form = function (form, options) {
			...
			plugin.$form.find( '.ea-file-delete' ).on(
				'click',
				function (e) {
					e.preventDefault();
