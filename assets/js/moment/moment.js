! ( function ( e, t ) {
	...
	function Qe() {
		...
		for ( t = 0; t < 7; t++ )
			( n = y( [ 2e3, 1 ] ).day( t ) ),
				...
				l.push( r );
		for (
			a.sort( e ), o.sort( e ), u.sort( e ), l.sort( e ), t = 0;
			t < 7;
			t++
		)
			( o[ t ] = he( o[ t ] ) ),
	...
	function Dt( e ) {
		...
		if ( i ) {
			...
			if (
				...
				t &&
					ze.indexOf( t ) !==
						new Date( n[ 0 ], n[ 1 ], n[ 2 ] ).getDay() &&
					( ( g( s ).weekdayMismatch = ! 0 ),
					! ( s._isValid = ! 1 ) ) )
			)
				return;
			( e._a = r ),
			...
			if ( e._f !== c.RFC_2822 ) {
				...
				for (
					...
					( i = s[ t ] ),
						( n = ( l.match( le( i, e ) ) || [] )[ 0 ] ) &&
							( 0 <
								( r = l.substr( 0, l.indexOf( n ) ) ).length &&
	...
	function Gt( e, t ) {
		...
		return t._isUTC
			? ( ( n = t.clone() ),
			  ( s =
					( k( e ) || d( e ) ? e.valueOf() : bt( e ).valueOf() ) -
					n.valueOf() ),
	...
	( mn.add = Jt ),
		( mn.calendar = function ( e, t ) {
			...
			return this.format(
				r || this.localeData().calendar( i, this, bt( n ) )
			);
		} ),
		( mn.clone = function () {
			return new M( this );
			...
			if ( this._monthsParseExact )
				return function ( e, t, n ) {
					...
					return n
						? 'MMM' === t
							? -1 !==
							  ( i = Ye.call( this._shortMonthsParse, a ) )
								? i
								: null
				...
				return function ( e, t, n ) {
					...
					return n
						? 'dddd' === t
							...
							: 'ddd' === t
							? -1 !==
							  ( i = Ye.call( this._shortWeekdaysParse, a ) )
								? i
								: null
							: -1 !==
							  ( i = Ye.call( this._minWeekdaysParse, a ) )
							? i
							: null
						: 'dddd' === t
						? -1 !== ( i = Ye.call( this._weekdaysParse, a ) )
	...
	return (
		...
		( qn.as = function ( e ) {
			...
			if ( 'month' === ( e = H( e ) ) || 'quarter' === e || 'year' === e )
				...
				switch (
					( ( t = this._days + Math.round( Dn( this._months ) ) ), e )
				) {
					case 'week':
						return t / 7 + s / 6048e5;
					case 'day':
