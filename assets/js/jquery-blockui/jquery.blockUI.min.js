...
! ( function () {
	...
	function e( x ) {
				...
				var s = function ( e ) {
					( e = e || {} ),
						x.blockUI( {
							message: i,
							fadeIn:
								'undefined' != typeof e.fadeIn ? e.fadeIn : 700,
							fadeOut:
								'undefined' != typeof e.fadeOut
									? e.fadeOut
									: 1e3,
							timeout:
								'undefined' != typeof e.timeout ? e.timeout : o,
							centerY: ! 1,
							showOverlay: ! 1,
							onUnblock: n,
		...
		function o( e, i ) {
			...
			( ( i = x.extend( {}, x.blockUI.defaults, i || {} ) )
				.ignoreIfBlocked &&
				x( e ).data( 'blockUI.isBlocked' ) ) ||
				( ( i.overlayCSS = x.extend(
					{},
					x.blockUI.defaults.overlayCSS,
					i.overlayCSS || {}
				) ),
				...
				U &&
					( i.theme
						? ( d.css( o ), d.addClass( 'ui-widget-content' ) )
						: d.css( t ) ),
				...
				( p =
					E &&
					( ! x.support.boxModel ||
						0 < x( 'object,embed', w ? null : e ).length ) ),
				( O || p ) &&
					( w &&
						i.allowBodyStretch &&
						x.support.boxModel &&
						x( 'html,body' ).css( 'height', '100%' ),
				...
				U &&
					( i.theme
						? d.find( '.ui-widget-content' ).append( U )
						: d.append( U ),
					( U.jquery || U.nodeType ) && x( U ).show() ),
				...
				i.fadeIn
					...
					: ( i.showOverlay && r.show(),
					  U && d.show(),
					  i.onBlock && i.onBlock.bind( d )() ),
				j( 1, e, i ),
				w
					? ( ( T = d[ 0 ] ),
					  ( M = x( i.focusableElements, T ) ),
					  i.focusInput && setTimeout( H, 20 ) )
					: ( function ( e, t, o ) {
							var n = e.parentNode,
								i = e.style,
								s =
		...
		function j( e, t, o ) {
			...
			( ! e &&
				...
				i &&
					...
					e
						? x( document ).bind( n, o, l )
						: x( document ).unbind( n, l ) ) );
		}
		function l( e ) {
			if (
				'keydown' === e.type &&
