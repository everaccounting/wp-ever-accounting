	...
	(o.fn.WCBackboneModal = function(e) {
		...
		(o.WCBackboneModal.View = e.View.extend({
			...
			addButton: function(e) {
				o(document.body).trigger('ea_backbone_modal_response', [this._target, this.getFormData()]), this.closeButton(e);
			},
			getFormData: function() {
				var n = {};
				return (
					o(document.body).trigger('ea_backbone_modal_before_update', this._target),
