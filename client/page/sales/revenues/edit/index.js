					...
					render={({ submitError, handleSubmit, form, submitting, pristine, values }) => (
						<form onSubmit={handleSubmit} className="ea-row">
							...
							<Field label={__('Category', 'wp-ever-accounting')} name="category" className="ea-col-6" required>
								{props => <CategorySelect create={true} type="income" {...props.input} {...props} />}
							</Field>
							...
							<Field
								...
								className="ea-col-6"
								accept={
									'image/*,.pdf,.doc,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document'
								}
								hasButton={true}
							>
								{props => <FileControl preview={false} {...props.input} {...props} />}
							</Field>
