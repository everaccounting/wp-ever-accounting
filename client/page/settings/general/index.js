...
import { TextControl, FileControl, FormCard, Button, CountrySelect } from '@eaccounting/components';
						...
						render={({ submitError, handleSubmit, form, submitting, pristine, values }) => (
							<form onSubmit={handleSubmit}>
								<div className="ea-row">
									...
									<Field label={__('Logo', 'wp-ever-accounting')} name="logo" className="ea-col-12">
