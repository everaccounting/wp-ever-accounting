...
class EditVendor extends Component {
	...
	onSubmit(form) {
		...
		this.props.handleSubmit(
			form,
			function (res) {
				NotificationManager.success(sprintf(__('Vendor %s.'), isAdd ? __('created') : __('updated')));
				history.push(`/purchases/vendors/${res.id}/edit`);
			},
			true
		);
	}
	...
	render() {
		...
		return (
			<FormCard title={isAdd ? __('Add Vendor') : __('Update Vendor')}>
				<Form
...
export default withEntity('contacts')(EditVendor);
