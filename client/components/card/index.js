				...
				{ title && (
					<div className="woocommerce-card__header">
						<div className="woocommerce-card__title-wrapper">
							<h2 className="woocommerce-card__title woocommerce-card__header-item">
								{ title }
							</h2>
							{ description && (
								<h2 className="woocommerce-card__description woocommerce-card__header-item">
									{ description }
								</h2>
							) }
						</div>
