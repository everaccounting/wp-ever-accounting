									...
									<div className="ea-row">
										...
										<div className="ea-col-6">
											<Field
												...
												required
											>
												{props => <AccountControl {...props.input} {...props} />}
											</Field>
										</div>
										...
										<div className="ea-col-6">
											<Field
												...
												required
											>
												{props => <CategoryControl type="expense" {...props.input} {...props} />}
											</Field>
										</div>

										<div className="ea-col-6">
											<Field label={__('Vendor', 'wp-ever-accounting')} name="contact" before={<Icon icon={'user'} />}>
												{props => <ContactControl {...props.input} {...props} />}
											</Field>
										</div>
										...
										<div className="ea-col-6">
											<Field
												...
												required
											>
												{props => <PaymentMethodControl {...props.input} {...props} />}
											</Field>
										</div>

										<div className="ea-col-12">
											<Field label={__('Description', 'wp-ever-accounting')} name="description">
										...
										<div className="ea-col-6">
											<Field name="files">{props => <FileUpload {...props.input} />}</Field>
										</div>
									</div>
