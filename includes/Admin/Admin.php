...
class Admin {
	...
	public function enqueue_scripts( $hook ) {
		...
		// Core scripts.
//		$admin_js_deps  = array( 'jquery', 'wp-util', 'eac-select2', 'eac-inputmask', 'jquery-ui-datepicker', 'jquery-ui-tooltip', 'eac-blockui', 'eac-modal', 'eac-alpine' );
//		$admin_css_deps = array( 'eac-jquery-ui', 'eac-select2' );
		$scripts->enqueue_script( 'eac-admin', 'js/eac-admin.js', [ 'eac-jquery-plugins', 'wp-util' ] );
		$scripts->enqueue_style( 'eac-admin', 'css/eac-admin.css', [ 'eac-jquery-plugins' ] );
