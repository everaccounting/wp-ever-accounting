...
class Accounts extends ListTable {
	...
	protected function handle_row_actions( $item, $column_name, $primary ) {
		...
		if ( ! current_user_can( 'eac_delete_account' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Reason: This is a custom capability.
			unset( $actions['delete'] );
		}

		if ( ! current_user_can( 'eac_edit_account' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Reason: This is a custom capability.
			unset( $actions['edit'] );
		}
