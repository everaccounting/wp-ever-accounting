			...
			<div class="eac-card eac-document-overview">
				...
				<div class="document-items">
					<table class="eac-document-items">
						...
						<tbody class="eac-document-items__toolbar"></tbody>
						<tfoot class="eac-document-items__totals"></tfoot>
					</table>
				</div><!-- .document-items -->
			...
			<div class="column-2">
				<div class="eac-card">
					...
					<div class="eac-card__footer">
						<?php if ( $bill->exists() ) : ?>
							<a class="eac_confirm_delete del" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'action', 'delete', admin_url( 'admin.php?page=eac-sales&tab=bills&id=' . $bill->id ) ), 'bulk-bills' ) ); ?>">
...
<script type="text/html" id="tmpl-eac-address">
...
<script type="text/html" id="tmpl-eac-empty">
...
<script type="text/html" id="tmpl-eac-item">
	<tr>
		<?php foreach ( $columns as $key => $label ) : ?>
...
<script type="text/html" id="tmpl-eac-toolbar">
	<tr>
		<td colspan="<?php echo count( $columns ); ?>">
