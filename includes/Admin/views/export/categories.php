...
<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
	<div class="bkit-card">
		<div class="bkit-card__header">
			<h2 class="bkit-card__title"><?php echo esc_html__( 'Export categories', 'wp-ever-accounting' ); ?></h2>
		</div>
		...
		<div class="bkit-card__footer">
			...
			<input name="export_type" value="categories" type="hidden">
