...
<tr>
	...
	<td class="col-amount">
		<div class="eac-input-group">
			...
			<input type="number" name="discount_value" id="discount_value" placeholder="10" style="text-align: right;width: auto;" value="<?php echo esc_attr( $invoice->discount_value ); ?>"/>
		</div>
	</td>
</tr>
