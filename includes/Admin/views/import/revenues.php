...
<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
	<div class="bkit-card">
		<div class="bkit-card__header">
			<h2 class="bkit-card__title"><?php echo esc_html__( 'Import Revenues', 'wp-ever-accounting' ); ?></h2>
		</div>
			...
			<div class="bkit-columns">
				<div class="bkit-col-6">
					<p>
						...
						$message = sprintf( __( 'Import revenues from CSV file. Download a <a href="%s"> sample </a> file to learn how to format the CSV file.', 'wp-ever-accounting' ), EAC()->get_dir_url( '/sample-data/import/revenues.csv' ) );
		...
		<div class="bkit-card__footer">
			...
			<input name="import_type" value="revenues" type="hidden">
