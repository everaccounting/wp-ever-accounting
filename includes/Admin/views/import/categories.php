...
<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
	<div class="bkit-card">
		<div class="bkit-card__header">
			<h2 class="bkit-card__title"><?php echo esc_html__( 'Import Categories', 'wp-ever-accounting' ); ?></h2>
		</div>
					...
					<p>
						...
						echo wp_kses_post(
							...
							/* translators: %s: sample file url.*/
								...
								EAC()->get_dir_url( '/sample-data/import/categories.csv' )
							)
						);
						?>
					</p>
		...
		<div class="bkit-card__footer">
			...
			<input name="import_type" value="categories" type="hidden">
