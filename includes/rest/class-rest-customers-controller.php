 ...
 */
class REST_Customers_Controller extends REST_Controller {
	/**
	 * Route base.
	 *
	 * @since 1.1.2
	...
	public function get_items( $request ) {
		...
		$items = Contacts::query_customers( $args );
	...
	public function get_item_permissions_check( $request ) {
		$resource = Contacts::get_customer( $request['id'] );
		if ( empty( $resource ) ) {
			return new \WP_Error(
				'rest_invalid_id',
	...
	public function get_item( $request ) {
		$item = Contacts::get_customer( $request['id'] );
		if ( empty( $item ) ) {
			return new \WP_Error(
				'rest_invalid_id',
				__( 'Invalid ID.', 'wp-ever-accounting' ),
	...
	public function create_item( $request ) {
		...
		$item = Contacts::insert_customer( wp_slash( (array) $props ) );
	...
	public function delete_item( $request ) {
		$contact = Contacts::get_customer( $request['id'] );
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'city'       => array(
					'description' => __( 'City of the customer.', 'wp-ever-accounting' ),
					'type'        => 'string',
					'context'     => array( 'embed', 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
