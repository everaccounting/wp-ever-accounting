 ...
 */
class REST_Categories_Controller extends REST_Controller {
	/**
	 * Route base.
	 *
	 * @var string
	...
	public function get_items( $request ) {
		...
		$items = Categories::get_categories( $args );
		$total = Categories::get_categories( $args, true );
	...
	public function get_item_permissions_check( $request ) {
		$resource = Categories::get_category( $request['id'] );
		if ( empty( $resource ) ) {
			return new \WP_Error(
				'rest_invalid_id',
	...
	public function get_item( $request ) {
		$item = Categories::get_category( $request['id'] );
		if ( empty( $item ) ) {
			return new \WP_Error(
				'rest_invalid_id',
				__( 'Invalid ID.', 'wp-ever-accounting' ),
	...
	public function create_item( $request ) {
		...
		$item = Categories::insert_category( wp_slash( (array) $props ) );
	...
	public function update_item_permissions_check( $request ) {
		$category = Categories::get_category( $request['id'] );
		if ( empty( $category ) ) {
			return new \WP_Error(
				'rest_invalid_id',
				__( 'Invalid ID.', 'wp-ever-accounting' ),
