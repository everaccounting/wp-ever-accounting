...
//		}
	...
	public function get_items( $request ) {
		...
		$args = apply_filters( 'ever_accounting_rest_currency_query', $request->get_params(), $request );

		$accounts = Accounts::query( $args );
	...
	public function create_item( $request ) {
		...
		$account = Accounts::insert( wp_slash( (array) $prepared_account ) );
	...
	public function prepare_item_for_response( $account, $request ) {
		 ...
		 * @param \WP_REST_Request $request Request object.
		 */
		return apply_filters( 'ever_accounting_rest_prepare_currency', $response, $account, $request );
	}
