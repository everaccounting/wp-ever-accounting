...
/**
 * Class REST_Revenues_Controller
 *
 * @since   1.1.2
 *
 * @package EverAccounting\REST
 */
class REST_Revenues_Controller extends REST_Controller {
	/**
	 * Route base.
	 *
	 * @since   1.1.2
	...
	public function get_items( $request ) {
		...
		$items = Transactions::get_revenues( $args );
		$total = Transactions::get_revenues( $args, true );
	...
	public function get_item_permissions_check( $request ) {
		$resource = Transactions::get_revenue( $request['id'] );
		if ( empty( $resource ) ) {
			return new \WP_Error(
				'rest_invalid_id',
	...
	public function get_item( $request ) {
		$item = Transactions::get_revenue( $request['id'] );
		if ( empty( $item ) ) {
			return new \WP_Error(
				'rest_invalid_id',
				__( 'Invalid ID.', 'wp-ever-accounting' ),
	...
	public function create_item( $request ) {
		...
		$item = Transactions::insert_revenue( wp_slash( (array) $props ) );
	 ...
	 *
	 * @param Revenue $item Revenue object.
