...
class EAccounting_Categories_List_Table extends WP_List_Table {
	...
	function column_name( $item ) {
		...
		$edit_url       = add_query_arg( [ 'eaccounting-action' => 'edit_category' ], $product_url );
		$activate_url   = add_query_arg( [ 'eaccounting-action' => 'activate_category' ], $product_url );
		$deactivate_url = add_query_arg( [ 'eaccounting-action' => 'deactivate_category' ], $product_url );
		$delete_url     = add_query_arg( [ 'eaccounting-action' => 'delete_category' ], $product_url );
