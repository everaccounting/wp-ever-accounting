...
//		}
		...
		$purchases    = add_submenu_page( 'eaccounting', __( 'Purchases', 'wp-ever-accounting' ), __( 'Purchases', 'wp-ever-accounting' ), 'manage_options', 'ea-purchases', 'eaccounting_admin_purchases_page' );
