...
class EAccounting_Admin_Assets {
	/**
	 * Hook in tabs.
	 */
	...
	public function admin_scripts() {
		...
		wp_register_script( 'eaccounting-admin', eaccounting()->plugin_url() . '/assets/js/admin/eaccounting-admin' . $suffix . '.js', array( 'jquery', 'jquery-validation' ), $version );
...
return new EAccounting_Admin_Assets();
