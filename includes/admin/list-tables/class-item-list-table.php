...
class Ever_Accounting_Item_List_Table extends Ever_Accounting_List_Table {
	...
	protected function render_blank_state() {
		...
		<div class="ea-empty-table">
			...
			<a href="<?php echo esc_url( ever_accounting_admin_url( array( 'page' => 'ea-items', 'tab' => 'items', 'action' => 'edit', ) ) ); //phpcs:ignore?>" class="button-primary ea-empty-table__cta"><?php _e( 'Add Item', 'wp-ever-accounting' ); ?></a>
