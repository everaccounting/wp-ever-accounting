	...
	protected function render_blank_state() {
		...
		<div class="ea-empty-table">
			<p class="ea-empty-table__message">
				<?php echo  esc_html__( 'Vendors are required if you want to create bills. You can see the balance you owe and filter reports by the vendor.', 'wp-ever-accounting' ); ?>
			</p>
