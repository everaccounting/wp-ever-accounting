...
/**
 * Class Ever_Accounting_Currency_List_Table
 * @since 1.1.0
 */
class Ever_Accounting_Currency_List_Table extends Ever_Accounting_List_Table {
	/**
	...
	function column_cb( $currency ) {
		return sprintf( '<input type="checkbox" name="currency_id[]" value="%s"/>', $currency->get_id() );
	}
