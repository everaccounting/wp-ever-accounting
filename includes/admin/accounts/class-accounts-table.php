...
class EAccounting_Accounts_Table extends WP_List_Table {
	/**
	...
	public function get_results() {
		...
		$this->active_count   = eaccounting_get_accounts( array_merge( $args, array( 'status' => '1' ) ), true );
		$this->inactive_count = eaccounting_get_accounts( array_merge( $args, array( 'status' => '0' ) ), true );
