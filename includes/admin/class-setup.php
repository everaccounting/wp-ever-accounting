...
class Setup_Wizard {
	...
	public function setup_wizard() {
		...
		wp_enqueue_script( 'ea-select2', eaccounting()->plugin_url( '/assets/js/ea-select2.js' ), array( 'jquery', 'jquery-select2' ), $version, true );
		wp_enqueue_script( 'ea-setup', eaccounting()->plugin_url( '/assets/js/ea-setup.js' ), array( 'jquery', 'ea-select2' ), $version, true );
