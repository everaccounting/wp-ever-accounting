...
class Setup_Wizard {
	...
	public function setup_wizard() {
		...
		wp_register_script( 'jquery-select2', eaccounting()->plugin_url( '/assets/js/select2/select2.full' . $suffix . '.js' ), array( 'jquery' ), $version, true );
		wp_enqueue_script( 'ea-select2', eaccounting()->plugin_url( '/assets/js/admin/ea-select2' . $suffix . '.js' ), array( 'jquery', 'jquery-select2' ), $version, true );
		wp_enqueue_script( 'ea-setup', eaccounting()->plugin_url( '/assets/js/admin/ea-setup' . $suffix . '.js' ), array( 'jquery', 'ea-select2' ), $version, true );
