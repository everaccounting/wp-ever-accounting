...
class Admin_Manager {
	...
	/**
	 * Change the admin footer text on Ever_Accounting admin pages.
	 *
	...
	public static function admin_footer_text( $footer_text ) {
		...
		// Check to make sure we're on a Ever_Accounting admin page.
	 ...
	 * @since 1.0.2
	 */
	public static function load_js_templates() {
		$screen    = get_current_screen();
