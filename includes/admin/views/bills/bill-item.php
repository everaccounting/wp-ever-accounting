...
<tr class="ea-document__line" data-item_id="<?php echo esc_attr( $item_id ); ?>">
	...
	<?php if ( Tax::tax_enabled() ) : ?>
		<td class="ea-document__line-tax" width="1%">
			<div class="view">
				<abbr title="<?php echo esc_html( Price::price( $item->get_tax(), $bill->get_currency_code() ) ); ?>"><?php echo esc_html( number_format_i18n( $item->get_tax_rate(), 4 ) ); ?><small>%</small></abbr>
			</div>
			<div class="edit" style="display: none;">
