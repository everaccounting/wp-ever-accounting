					...
					<div class="ea-card">
						<div class="ea-card__inside">
							<div class="ea-row">
								...
								eaccounting_hidden_input( 'currency_rate', $bill->get_currency_rate() );
								eaccounting_hidden_input( 'discount', $bill->get_discount() );
								eaccounting_hidden_input( 'discount_type', $bill->get_discount_type() );
								eaccounting_hidden_input( 'action', 'eaccounting_edit_bill' );
								?>
				...
				<div id="postbox-container-1" class="postbox-container">
					<div class="ea-card">
						...
						<div class="ea-card__footer">
							<?php if ( $bill->exists() && $bill->is_draft() ) : ?>
								<a href="#"><?php esc_html_e( 'Remove', 'wp-ever-accounting' ); ?></a>
							<?php endif; ?>
