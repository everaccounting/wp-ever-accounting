...
if ( empty( $account ) || ! $account->exists() ) {
	wp_die( esc_attr__( 'Sorry, Account does not exist', 'wp-ever-accounting' ) );
}
					...
					<div class="ea-widget-card success">
						...
						<div class="ea-widget-card__content">
							<div class="ea-widget-card__primary">
                                ...
                                <span class="ea-widget-card__amount"><?php echo eaccounting_format_price( $account->get_balance(), $account->get_currency_code() ); //phpcs:ignore ?></span>
							</div>
						</div>
					</div><!--.ea-widget-card-->
					...
					<div class="ea-widget-card">
						...
						<div class="ea-widget-card__content">
							<div class="ea-widget-card__primary">
                                ...
                                <span class="ea-widget-card__amount"><?php echo eaccounting_format_price( $account->get_opening_balance(), $account->get_currency_code() ); //phpcs:ignore ?></span>
							</div>
						</div>
					</div><!--.ea-widget-card-->
			...
			<div class="ea-card">
				...
				<div class="ea-list-group">
					...
					<div class="ea-list-group__item">
                        ...
                        <div class="ea-list-group__text"><?php echo ! empty( $account->get_currency_code() ) ? $account->get_currency_code() : '&mdash;'; //phpcs:ignore ?></div>
					</div>
					<div class="ea-list-group__item">
						<div class="ea-list-group__title"><?php esc_html_e( 'Bank Name', 'wp-ever-accounting' ); ?></div>
                        <div class="ea-list-group__text"><?php echo ! empty( $account->get_bank_name() ) ? $account->get_bank_name() : ' &mdash;'; //phpcs:ignore ?></div>
					</div>
					<div class="ea-list-group__item">
						<div class="ea-list-group__title"><?php esc_html_e( 'Bank Phone Number', 'wp-ever-accounting' ); ?></div>
						<div class="ea-list-group__text"><?php echo ! empty( $account->get_bank_phone() ) ? $account->get_bank_phone() : '&mdash;'; //phpcs:ignore ?></div>
					</div>
					<div class="ea-list-group__item">
						<div class="ea-list-group__title"><?php esc_html_e( 'Bank Address', 'wp-ever-accounting' ); ?></div>
						<div class="ea-list-group__text"><?php echo ! empty( $account->get_bank_address() ) ? $account->get_bank_address() : '&mdash;'; //phpcs:ignore ?></div>
					</div>
				</div>
