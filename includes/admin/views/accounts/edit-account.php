	...
	<div class="ea-title-section">
		<div>
			...
			<?php if ( $account->exists() ) : ?>
				<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'accounts', 'page' => 'ea-banking', 'action' => 'add' ), admin_url( 'admin.php' ) ) );//phpcs:ignore ?>"
...
<?php
$currency = eaccounting_get_account_currency( $account->get_id() );
if ( $currency ) {
