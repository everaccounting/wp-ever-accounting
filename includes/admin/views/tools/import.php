...
<div class="ea-card">
    <div class="ea-card__header is-compact">
        <h3 class="ea-card__title"><?php _e( 'Import Invoices', 'wp-ever-accounting' ); ?></h3>
    </div>

    <div class="ea-card__inside">
        <form action="" method="post" enctype="multipart/form-data" class="ea-importer ea-batch"
              data-type="import-invoices"
              data-nonce="<?php echo wp_create_nonce( 'import-invoices_importer_nonce' ); ?>">
            <p>
				<?php
				echo wp_kses_post(
					sprintf(
						__( 'Import invoices from CSV file. Download a <a href="%s"> sample </a> file to learn how to format the CSV file.', 'wp-ever-accounting' ),
						eaccounting()->plugin_url( '/sample-data/import/invoices.csv' )
					)
				);
				?>
            </p>
            ...
            <div class="ea-importer-bottom">
                ...
                <table class="widefat striped fixed">
                    ...
                    <tbody>
					<?php eaccounting_do_import_fields( 'invoice' ); ?>
                    </tbody>
                </table>
