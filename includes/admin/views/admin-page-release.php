...
<div class="ea-title-section">
	<div class="ea-container">
		<div class="ea-release_logo">
			<a href="https://wpeveraccounting.com/"><img src="<?php echo eaccounting()->plugin_url( '/assets/dist/images/everaccountinglogo.png' ); ?>" alt="ea-release-logo"></a>
		</div>
		...
		<div id="post-body" class="metabox-holder columns-2">
			<div id="post-body-content">
				<div class="ea-card">
					<div class="ea-card__header">
						<h3><span class="dashicons dashicons-megaphone"></span><span><?php _e( " What's New in WP Ever Accounting ", 'wp-ever-accounting' ); ?></span></h3>
					</div>
					<!-- /.ea-card__header -->
			...
			<div id="postbox-container-1" class="postbox-container">
				<div class="ea-card">
					...
					<div class="ea-card__inside">
						<img src="<?php echo eaccounting()->plugin_url( '/assets/dist/images/dashboard.png' ); ?>" alt="dashboard" class="ea-release__dashboard">
