	...
	<form action="" method="post">
		...
		Form::text_input(
			array(
				...
				'desc'        => sprintf( __( 'Total amount due:%s', 'wp-ever-accounting' ), Price::price( $bill->get_total_due(), $bill->get_currency_code() ) ),
			)
		);
		...
		Form::hidden_input(
			array(
				'name'  => 'action',
				'value' => 'ever_accounting_add_bill_payment',
			)
		);
