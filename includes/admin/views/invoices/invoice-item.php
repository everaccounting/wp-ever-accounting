...
<tr class="ea-document__line" data-item_id="<?php echo esc_attr( $item_id ); ?>">
	...
	<td class="ea-document__line-price" width="1%" data-value="<?php echo $item->get_price(); ?>">
		<div class="view">
			<?php
            /** echo esc_html( eaccounting_price( $item->get_price(), $invoice->get_currency_code() ) );  */
	...
	<td class="ea-document__line-subtotal" width="1%">
		<div class="view">
			<span class="line_item_subtotal">
                <?php /**echo esc_html( eaccounting_format_price( $item->get_subtotal(), $invoice->get_currency_code() ) );  */
