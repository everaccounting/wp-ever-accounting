		...
		<div class="ea-card">
			<div class="ea-card__header">
				...
				<div>
					...
					?>
					<button class="button-primary button receive-payment"><?php _e( 'Receive Payment', 'wp-ever-accounting' ); ?></button>
				</div>
			</div>
			<div class="ea-card__inside">
				...
				<div class="ea-invoice view-mode">
									...
									<td>
										...
										<div class="ea-invoice__address">
												<span class="ea-invoice__address-line">
													<?php echo eaccounting_format_address( maybe_unserialize( $invoice->get_address() ) ); ?>
												</span>
										</div>
									</td>
								</tr>
					...
					<?php eaccounting_get_admin_template( 'invoices/partials/items', array( 'invoice' => $invoice ) ); ?>
