...
<div class="ea-card ea-report-card">
	<div class="ea-card-header">
		...
		<form action="" class="ea-report-filter">
			...
			<input type="hidden" name="tab" value="expense_summery">
		</form>
	...
	<div class="ea-card-body">
		...
		<div class="ea-report-graph">
			<canvas id="expense-summer-graph" height="300" style="width: 100%;"></canvas>
		</div>
...
<script>
	jQuery(document).ready(function ($) {
		var ctx = document.getElementById("expense-summer-graph");
		...
		var data = {
			...
			datasets: [{
					...
					data: <?php echo json_encode(array_values($expenses_graph), true );?>,
				},
			]
		};
