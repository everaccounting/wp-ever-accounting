...
<div class="wrap ea-wrapper">
	...
	if ( isset( $_GET['eaccounting-action'] ) && $_GET['eaccounting-action'] == 'add_transfer' ) {
		eaccounting_get_views( 'edit-transfer.php' );
		...
		$base_url = admin_url( 'admin.php?page=eaccounting-transfers' );
		?>
		<h1 class="wp-heading-inline"><?php _e( 'Transfers', 'wp-ever-accounting' ); ?></h1>
		<a href="<?php echo esc_url( add_query_arg( array( 'eaccounting-action' => 'add_transfer' ), admin_url( 'admin.php?page=eaccounting-transfers' ) ) ); ?>"
		...
		<form method="get" action="<?php echo esc_url( $base_url ); ?>">
			<div class="ea-list-table">
				<input type="hidden" name="page" value="eaccounting-transfers"/>
