                    ...
                    <div class="ea-widget-card">
                        ...
                        <div class="ea-widget-card__content">
                            <div class="ea-widget-card__primary">
                                ...
                                <span class="ea-widget-card__amount"><?php echo eaccounting_format_price( eaccounting_price_convert( $customer->get_total_paid(), eaccounting_get_default_currency(), $customer->get_currency_code() ), $customer->get_currency_code() ); ?></span>
                            </div>
                        </div>
                    </div><!--.ea-widget-card-->
                    ...
                    <div class="ea-widget-card alert">
                        ...
                        <div class="ea-widget-card__content">
                            <div class="ea-widget-card__primary">
                                ...
                                <span class="ea-widget-card__amount"><?php echo eaccounting_format_price( eaccounting_price_convert( $customer->get_total_due(), eaccounting_get_default_currency(), $customer->get_currency_code() ), $customer->get_currency_code() ); ?></span>
                            </div>
                        </div>
                    </div><!--.ea-widget-card-->
