...
class EAccounting_Report_Sales extends EAccounting_Admin_Report {
	/**
	 * @since 1.1.0
	 *
	 * @param array $args
		...
		<div class="ea-card">
				...
				<div class="ea-card__toolbar">
					<form action="<?php echo admin_url( 'admin.php?page=ea-reports' ); ?>>" method="get">
						...
						<?php if ( isset( $_GET['filter'] ) ) : ?>
							<a class="button-secondary" href="<?php echo esc_url( admin_url( 'admin.php?page=ea-reports&tab=sales' ) ); ?>"><?php esc_html_e( 'Reset', 'wp-ever-accounting' ); ?></a>
						<?php endif; ?>
					</form>
				</div>
			</div>
			<?php if ( ! empty( $year ) ) : ?>
				...
				<div class="ea-card__footer">
					<a class="button button-secondary" href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=ea-reports&tab=sales&refresh_report=yes' ), 'refresh_report' ); ?>">
