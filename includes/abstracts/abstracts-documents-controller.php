	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'address'          => array(
					'description' => __( 'Address of the Document.', 'wp-ever-accounting' ),
					'type'        => 'object',
					'context'     => array( 'embed', 'view', 'edit' ),
					'required'    => false,
					'readonly'    => true,
					'properties'  => array(
						...
						'street'     => array(
							'description' => __( 'Street', 'wp-ever-accounting' ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
							'arg_options' => array(
								'sanitize_callback' => 'sanitize_text_field',
		...
		if ( 'bills' === $this->rest_base ) {
			$schema['properties']['vendor'] = $contact;
		} elseif ( 'invoices' === $this->rest_base ) {
