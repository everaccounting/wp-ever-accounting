...
function eac_update_120() {
	...
	$wpdb->query( "ALTER TABLE $table MODIFY COLUMN currency VARCHAR(3) NOT NULL DEFAULT 'USD' AFTER number" );
	$drops = array( 'enabled', 'currency_code', 'date_created', 'thumbnail_id', 'creator_id' );
