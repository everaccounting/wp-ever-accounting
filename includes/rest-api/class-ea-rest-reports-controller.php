...
class EverAccounting_Reports_Controller extends EverAccounting_REST_Controller {
	...
	public function register_routes() {
		...
		register_rest_route(
			$this->namespace,
			'/' . $this->rest_base . '/income_categories',
			array(
				array(
					'methods'             => WP_REST_Server::READABLE,
		...
		register_rest_route(
			$this->namespace,
			'/' . $this->rest_base . '/expense_categories',
			array(
				array(
					'methods'             => WP_REST_Server::READABLE,
		...
		register_rest_route(
			$this->namespace,
			'/' . $this->rest_base . '/income_expense_report',
			array(
				array(
					'methods'             => WP_REST_Server::READABLE,
	...
	public function get_summery( $request ) {
		...
		$incomes  = eaccounting_get_transactions(
			array_merge(
				[
