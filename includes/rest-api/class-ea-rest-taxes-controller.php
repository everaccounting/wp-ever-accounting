...
class EverAccounting_Taxes_Controller extends EverAccounting_REST_Controller {
	/**
	 * @var string
	 */
	...
	public function get_items( $request ) {
		...
		$query_result = eaccounting_get_taxes( $args );
		$total_items  = eaccounting_get_taxes( $args, true );
		$response     = array();
	...
	public function create_item( $request ) {
		...
		$item_id = eaccounting_insert_tax( (array) $prepared );
	...
	public function update_item( $request ) {
		...
		if ( ! empty( $prepared_args ) ) {
			$updated = eaccounting_insert_tax( (array) $prepared_args );
	...
	public function get_item_schema() {
		$schema = array(
			...
			'title'      => __( 'Tax Rate', 'wp-ever-accounting' ),
			'type'       => 'object',
			'properties' => array(
				'id'           => array(
