...
class Accounts extends Controller {
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( empty( $account ) || ! current_user_can( 'eac_read_account' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function update_item_permissions_check( $request ) {
		...
		if ( empty( $account ) || ! current_user_can( 'eac_edit_account' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( empty( $account ) || ! current_user_can( 'eac_delete_account' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
