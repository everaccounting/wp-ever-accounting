...
class Vendors extends Contacts {
	...
	public function update_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_edit_vendor' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_read_vendor' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_delete_vendor' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
