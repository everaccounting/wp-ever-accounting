...
class Taxes extends Controller {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! current_user_can( 'eac_read_tax' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( empty( $tax ) || ! current_user_can( 'eac_read_tax' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function update_item_permissions_check( $request ) {
		...
		if ( empty( $tax ) || ! current_user_can( 'eac_edit_tax' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( empty( $tax ) || ! current_user_can( 'eac_delete_tax' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability
			return new \WP_Error(
				'rest_forbidden_context',
