 ...
 * @return string
 */
function eac_get_currency() {
	$currency = get_option( 'eac_currency', 'USD' );

	return apply_filters( 'eac_currency', strtoupper( $currency ) );
}
 ...
 * @return string
 */
function eac_get_currency_symbol( $currency = '' ) {
	if ( empty( $currency ) ) {
