 ...
 *
 * @return EverAccounting\Legacy\Models\Account|null
 */
function eaccounting_get_account( $account ) {
	...
	try {
		$result = new EverAccounting\Legacy\Models\Account( $account );
 ...
 *
 * @return EverAccounting\Legacy\Models\Account|\WP_Error|bool
...
function eaccounting_insert_account( $data, $wp_error = true ) {
	...
	try {
		...
		$item = new \EverAccounting\Legacy\Models\Account( $data['id'] );
...
function eaccounting_delete_account( $account_id ) {
	try {
		$account = new EverAccounting\Legacy\Models\Account( $account_id );
...
function eaccounting_get_accounts( $args = array() ) {
	...
	$table        = \EverAccounting\Legacy\Repositories\Accounts::TABLE;
	$columns      = \EverAccounting\Legacy\Repositories\Accounts::get_columns();
