...
class Install {
	...
	public static function install() {
		...
		if ( ! eaccounting()->settings ) {
			eaccounting()->settings = new \EverAccounting\Legacy\Settings();
		}
	...
	public static function verify_base_tables() {
		...
		$notices        = \EverAccounting\Legacy\Admin\Notices::init();
	...
	public static function run_update_callback( $callback ) {
		include_once EACCOUNTING_LEGACY_PATH . '/ea-update-functions.php';
