 ...
 * @since   1.0.2
 *
 * @package EverAccounting\Legacy\Import
 */

namespace EverAccounting\Legacy\Import;

use EverAccounting\Legacy\Abstracts\CSV_Importer;
...
class Accounts extends CSV_Importer {
	...
	protected function import_item( $data ) {
		...
		$currency = new \EverAccounting\Legacy\Models\Currency( array( 'code' => $data['currency_code'] ) );
