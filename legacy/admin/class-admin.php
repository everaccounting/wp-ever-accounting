...
namespace EverAccounting\Legacy\Admin;
...
class Admin {
	...
	public function includes() {
		require_once EACCOUNTING_LEGACY_PATH . '/admin/ea-admin-functions.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-notices.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-menu.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-assets.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-settings.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-exporter.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-importer.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-dashboard.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-invoice-actions.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-bill-actions.php';
		require_once EACCOUNTING_LEGACY_PATH . '/admin/class-extensions.php';
