...
class Menu {
	...
	public function render_sales_report_tab() {
		...
		$report = new \EverAccounting\Legacy\Admin\Report\Sales();
		$report->output();
	}
	...
	public function render_expenses_report_tab() {
		...
		$report = new \EverAccounting\Legacy\Admin\Report\Expenses();
		$report->output();
	}
	...
	public function render_profits_report_tab() {
		...
		$report = new \EverAccounting\Legacy\Admin\Report\Profits();
		$report->output();
	}
	...
	public function render_cashflow_report_tab() {
		...
		$report = new \EverAccounting\Legacy\Admin\Report\CashFlow();
		$report->output();
	}
