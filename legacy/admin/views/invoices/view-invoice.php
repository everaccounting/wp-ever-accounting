...
if ( $invoice->exists() ) {
	add_meta_box( 'invoice_payments', __( 'Invoice Payments', 'wp-ever-accounting' ), array( '\EverAccounting\Legacy\Admin\Invoice_Actions', 'invoice_payments' ), 'ea_invoice', 'side' );
	add_meta_box( 'invoice_notes', __( 'Invoice Notes', 'wp-ever-accounting' ), array( '\EverAccounting\Legacy\Admin\Invoice_Actions', 'invoice_notes' ), 'ea_invoice', 'side' );
}
/**
