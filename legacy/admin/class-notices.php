...
class Notices {
	...
	public static function init() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof \EverAccounting\Legacy\Admin\Notices ) ) {
 ...
 *
 * @since 1.1.0
 * @return \EverAccounting\Legacy\Admin\Notices|null
 */
function eaccounting_admin_notices() {
	return \EverAccounting\Legacy\Admin\Notices::init();
}
