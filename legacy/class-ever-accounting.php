...
use EverAccounting\Legacy\Logger;
use EverAccounting\Legacy\Options;
use EverAccounting\Legacy\Utilities;
...
final class EverAccounting {
	...
	public function define_constants() {
		...
		define( 'EACCOUNTING_BASENAME', plugin_basename( EACCOUNTING_PLUGIN_FILE ) );
		define( 'EACCOUNTING_DIR_PATH', plugin_dir_path( EACCOUNTING_PLUGIN_FILE ) );
		define( 'EACCOUNTING_LEGACY_PATH', dirname( __FILE__ ) );
		define( 'EACCOUNTING_URL', plugins_url( '', EACCOUNTING_PLUGIN_FILE ) );
		define( 'EACCOUNTING_ASSETS_URL', EACCOUNTING_URL . '/assets' );
		define( 'EACCOUNTING_TEMPLATES_DIR', EACCOUNTING_DIR_PATH . '/templates' );
	...
	public function includes() {
		...
		// Abstract classes.
		require_once EACCOUNTING_LEGACY_PATH . '/abstracts/abstract-registry.php';
		require_once EACCOUNTING_LEGACY_PATH . '/abstracts/abstract-assets.php';
		require_once EACCOUNTING_LEGACY_PATH . '/abstracts/abstract-background-process.php';

		// Core classes.
		require_once EACCOUNTING_LEGACY_PATH . '/class-install.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-utilities.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-options.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-ajax.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-assets.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-rewrites.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-controller.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-compatibility.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-chart.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-collection.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-datetime.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-inflector.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-logger.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-money.php';
		require_once EACCOUNTING_LEGACY_PATH . '/class-repositories.php';
		require_once EACCOUNTING_LEGACY_PATH . '/core-functions.php';

		if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
			require_once EACCOUNTING_LEGACY_PATH . '/admin/class-admin.php';
		}
