...
namespace EverAccounting\Legacy;

use EverAccounting\Legacy\Abstracts\Resource_Model;
use EverAccounting\Legacy\Repositories\Accounts;
use EverAccounting\Legacy\Repositories\Categories;
use EverAccounting\Legacy\Repositories\Contacts;
use EverAccounting\Legacy\Repositories\Currencies;
use EverAccounting\Legacy\Repositories\Transactions;
use EverAccounting\Legacy\Repositories\Notes;
use EverAccounting\Legacy\Repositories\Document_Items;
use EverAccounting\Legacy\Repositories\Documents;
use EverAccounting\Legacy\Repositories\Items;
use EverAccounting\Legacy\Abstracts\Resource_Repository;
use EverAccounting\Legacy\Repositories\Transfers;
 ...
 * @since   1.1.0
 *
 * @package EverAccounting\Legacy\Repositories
 */
class Repositories {
	/**
