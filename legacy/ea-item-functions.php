...
use EverAccounting\Legacy\Models\Item;
 ...
 *
 * @return EverAccounting\Legacy\Models\Item|null
 * @since 1.1.0
 */
function eaccounting_get_item( $item ) {
	...
	try {
		$result = new EverAccounting\Legacy\Models\Item( $item );
 ...
 *
 * @return EverAccounting\Legacy\Models\Item|WP_Error|bool
 * @since 1.1.0
 */
...
function eaccounting_delete_item( $item_id ) {
	try {
		$item = new EverAccounting\Legacy\Models\Item( $item_id );
...
function eaccounting_get_items( $args = array() ) {
	...
	$table        = \EverAccounting\Legacy\Repositories\Items::TABLE;
	$columns      = \EverAccounting\Legacy\Repositories\Items::get_columns();
