 ...
 * @since   1.0.2
 *
 * @package EverAccounting\Legacy\Export
 */

namespace EverAccounting\Legacy\Export;

use EverAccounting\Legacy\Abstracts\CSV_Exporter;
...
class Currencies extends CSV_Exporter {
	 ...
	 *
	 * @param \EverAccounting\Legacy\Models\Currency $item Currency object.
	 *
	 * @return array
	 */
