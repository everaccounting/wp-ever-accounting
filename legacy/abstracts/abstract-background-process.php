 ...
 *
 * @package EverAccounting\Legacy\Classes
 */
...
if ( ! class_exists( '\WP_Async_Request', false ) ) {
	include_once EACCOUNTING_LEGACY_PATH . '/libraries/wp-async-request.php';
}

if ( ! class_exists( '\WP_Background_Process', false ) ) {
	include_once EACCOUNTING_LEGACY_PATH . '/libraries/wp-background-process.php';
}
