...
/**
 * Get a stable query key from a query object.
 *
 * @param {Object} query        Query object.
 * @param {Object} defaultQuery Default query object.
 * @return {string} Stable query key.
 */
export const getStableQueryKey = ( query = {}, defaultQuery = {} ) => {
	return pickBy(
		query.filter( ( value, key ) => {
			return defaultQuery[ key ] !== value;
		} ),
		( value ) => value || value === 0
	)
		.sort()
