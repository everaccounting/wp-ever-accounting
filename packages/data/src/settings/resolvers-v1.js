 ...
 * @return {Object} Setting object
 */
export const getOptions = forwardResolver( 'getSettings' );
 ...
 */
export const getOption = forwardResolver( 'getSettings' );
 ...
 * @return {*} Setting option
 */
export const getDirtyOptions = forwardResolver( 'getSettings' );
