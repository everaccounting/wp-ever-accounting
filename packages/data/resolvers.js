...
import { fetchFromAPIWithTotal, select } from './controls';
...
export function* getEntityTotal( name, query = {} ) {
	yield select( STORE_KEY, 'getEntityRecords', name, query );
	return yield select( STORE_KEY, 'getEntityTotal', name, query );
}
