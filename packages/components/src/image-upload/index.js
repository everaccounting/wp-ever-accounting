		...
		<>
			{ !! image && (
				<div className={ classNames( 'woocommerce-image-upload', 'has-image', className ) }>
					...
					<Button isSecondary className="woocommerce-image-upload__remove-image" onClick={ removeImage }>
			...
			{ ! image && (
				<div className={ classNames( 'woocommerce-image-upload', 'no-image', className ) }>
					<Button className="woocommerce-image-upload__add-image" onClick={ openModal } isSecondary>
						<Icon icon={ upload } />
