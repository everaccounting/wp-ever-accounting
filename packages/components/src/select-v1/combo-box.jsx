...
const ToggleButton = forwardRef( ( props, ref ) => {
	...
	return (
		<button className="eac-select-control__combox-box-toggle-button" { ...props } ref={ ref }>
	...
	return (
		...
		<div
			className={ classNames( 'eac-select-control__combo-box-wrapper', {
				'eac-select-control__combo-box-wrapper--disabled': inputProps.disabled,
			} ) }
			onMouseDown={ maybeFocusInput }
		>
			<div className="eac-select-control__items-wrapper">
				{ children }
				<div { ...comboBoxProps } className="eac-select-control__combox-box">
					<input
						{ ...inputProps }
						ref={ ( node ) => {
			...
			{ suffix && <div className="eac-select-control__suffix">{ suffix }</div> }
