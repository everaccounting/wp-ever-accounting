...
function SelectControl( {
	...
	children = ( { items: renderItems, highlightedIndex, getItemProps, getMenuProps, isOpen } ) => {
		return (
	...
	const instanceId = useInstanceId( SelectControl, 'woocommerce-experimental-select-control' );
	...
	return (
		<div
			...
			className={ classnames( 'woocommerce-experimental-select-control', className, {
