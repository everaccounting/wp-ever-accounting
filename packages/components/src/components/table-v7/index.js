...
import { SearchControl, Button, Dropdown, MenuGroup, MenuItem } from '@wordpress/components';
import { __, sprintf } from '@wordpress/i18n';
/**
 * Internal dependencies
 */
import { useControlledValue, useControlledState, usePrevious } from '../../hooks';
...
function Table( props ) {
	...
	const data = loading && previousData ? previousData : _data;
	...
	return (
		<div className={ classes } style={ props.style }>
			...
			<Pagination totalCount={ totalCount } query={ query } onChange={ setPagination } />
		</div>
	);
}
