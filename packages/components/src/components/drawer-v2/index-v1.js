...
function Drawer( props ) {
	...
	const classNames = classnames( 'eac-drawer', className );
	return (
		<Fill name="app-footer">
			<div
			...
			>
				<div className="eac-drawer__header">
					<div className="eac-drawer__title">
						<Text style={ { fontSize: '1.2em' } }>{ title }</Text>
					</div>
					<div className="eac-drawer__header-toolbar">
						{ renderToolbar && { renderToolbar } }
						<Button onClick={ onClickOutSide } style={ { height: 'auto', padding: 0 } }>
							<Icon icon="exit" style={ { transform: 'rotate(180deg)' } } />
						</Button>
					</div>
				</div>
