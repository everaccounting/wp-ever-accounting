...
function List( {
	...
	const paginationContent = pagination ? (
		<div className={ classNames( `${ prefixCls }-pagination`, `${ prefixCls }-pagination-align-${ paginationProps?.align ?? 'end' }` ) }>
			<Pagination_v1 { ...paginationProps } onChange={ onPaginationChange } onShowSizeChange={ onPaginationShowSizeChange } />
		</div>
	) : null;
