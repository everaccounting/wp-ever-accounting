// https://github.com/core-ds/core-components/blob/b9e445af450ae6fb128a6c0e54421c5f0bb5c740/packages/select/src/components/base-select/Component.tsx#L18
...
export const BaseSelect = forwardRef(
	...
	(props, ref) => {
				...
				switch (type) {
					...
					case useCombobox.stateChangeTypes.ItemClick: {
						...
						return {
							...changes,
							selectedItem:
								state.selectedItem === selectedItem ? null : selectedItem,
		...
		const renderValue = () => selectedItems.map(option => (
		...
		const renderEmptyPlaceholder = () => {
			...
			if (showSearch) {
				return (
					<div className={styles.emptySearchPlaceholder}>Ничего не нашлось</div>
				)
			}
			...
			return (
				...
				>
					<OptionsList
						...
						setHighlightedIndex={
							view === "desktop" ? setHighlightedIndex : undefined
						}
